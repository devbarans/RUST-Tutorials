    ...
    // Vector, standart kütüphanede tanımlanmıştır. Kullanmak için std::vec::Vec modülünü eklememize gerek yoktur.
    // Vector, heap'te tutulur. Bu nedenle, vector'ün boyutu çalışma zamanında değiştirilebilir.
